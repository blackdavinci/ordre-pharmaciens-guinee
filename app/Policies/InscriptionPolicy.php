...
//    }
    ...
    {
        return $user->can('delete_any_inscription');
    }
    ...
    {
        return $user->can('force_delete_any_inscription');
    }
    ...
    {
        return $user->can('restore_any_inscription');
    }

    /**
     * Determine whether the user can replicate.
     */
    public function replicate(User $user, Inscription $inscription): bool
    {
        return $user->can('replicate_inscription');
    }
    ...
    {
        return $user->can('reorder_inscription');
    }
}
